...
public class WordCountKafka {
    public static void main(String[] args) throws Exception {
        ...
        String topic = "li_flink";
        Properties consumerProperties = new Properties();
        consumerProperties.setProperty("bootstrap.servers", "192.168.123.153:9092");
        ...
        result.map(tuple -> tuple.toString()).print();
        env.execute("WordCount with Kafka");
    }
}
